...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("LEVO");
    case mBTC: return QString("mLEVO");
    case uBTC: return QString::fromUtf8("μLEVO");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("LevoCoins"));
    case mBTC: return QString(QObject::tr("Milli-LevoCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-LevoCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
