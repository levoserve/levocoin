...
static const char *strDNSSeed[][2] = {
    {"162.243.28.171", "162.243.28.171"},
	{"162.243.113.23", "162.243.113.23"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. LevoCoin is probably already running."), addrBind.ToString().c_str());
        else
